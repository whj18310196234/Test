...
public class A2 {
	...
	public static void main(String[] args) throws Exception {
		//读取文件
		File input = new File("C:/Users/dell/Desktop/测试老版数据/新建文本文档(3).txt");
		FileReader reader = new FileReader(input);//定义一个fileReader对象，用来初始化BufferedReader
		...
		map.put("SUB_1_1_16_2",null);
		map.put("SUB_1_1_16",tbody.child(9).select("input[name=textfield12323]").get(0).val());
		
		map.put("SUB_1_1_17_1",null);
		map.put("SUB_1_1_17_2",null);
		map.put("SUB_1_1_17_3",null);
		...
		map.put("SUB_1_1_23",tbody.child(9).select("input[name=textfield822]").get(0).val());
		map.put("SUB_1_1_24",tbody.child(9).select("input[name=textfield1233]").get(0).val());
		map.put("SUB_1_1_25",tbody.child(9).select("input[name=textfield1323]").get(0).val());
		...
		map.put("SUB_1_2_16_2",null);
		map.put("SUB_1_2_16",tbody.child(9).select("input[name=textfield12323]").get(1).val());
		
		map.put("SUB_1_2_17_1",null);
		map.put("SUB_1_2_17_2",null);
		map.put("SUB_1_2_17_3",null);
		...
		map.put("SUB_3_7_4_1",null);
		if(inputs.get(3).select("[checked]").size()>0)
		map.put("SUB_3_7_4_1","√");
		
		map.put("SUB_3_7_4_2",null);
...
//		map.put("SUB_10_25_1_1",null);
		...
		//TODO 附件一
		map.put("SUB_FJ1_1",null);
		map.put("SUB_FJ1_2",null);
...
//		Elements d = tbody.getElementsMatchingOwnText("1.纳入该商品房分摊的共用部");
